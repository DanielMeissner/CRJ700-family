...
var setlistener = EFISBase.setlistener;
var cleanup = func()
{
        print("EFIS cleanup... ");
        EFISBase.removelisteners();
        efis.del();
        setlistener = orig_setlistener;
};
#-- end development ----------------------------------------------------------
...
{
    if (p.getValue()) {
        print("Init CRJ700 EFIS...");
        EFISSetup();
    }
}, 1, 0);
#print("EFIS initL "~initL);

#restore original setlistener
#setlistener = orig_setlistener;
