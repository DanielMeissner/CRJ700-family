...
var EFIS_setlistener = setlistener;
...
var EFISBase = 
{
    ...
    setlistener: func(p, f, s=0, r=1) {
       ...
       append(EFISBase._listeners, EFIS_setlistener(p,f,s,r));
       #print("EFIS listeners "~size(EFISBase._listeners));
    },  
    
    removelisteners: func() {
        var msg = "Removing EFIS listeners ";
        foreach (var id; EFISBase._listeners) {
            removelistener(id);
            msg = msg~" "~id;
        }
        print(msg);
...
var DisplayUnit =
{
    ...
    asWindow: func(window_size) {
        ...
        me.window.move(me._id*200, me._id*20);
