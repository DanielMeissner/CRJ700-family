...
var sound_switchclick2 = Switch_sound.new("sim/sound/click2", 0.1,
    ...
    "instrumentation/efis/mfd[0]/mfd/display-mode",
    "instrumentation/efis/mfd[0]/inputs/range-nm",
    "instrumentation/efis/mfd[1]/mfd/display-mode",
    "instrumentation/efis/mfd[1]/inputs/range-nm",
    "instrumentation/mfd[0]/inputs/tcas",
    "instrumentation/mfd[0]/inputs/wx",
    "instrumentation/mfd[1]/inputs/tcas",
    "instrumentation/mfd[1]/inputs/wx",
    "instrumentation/use-QNH",
